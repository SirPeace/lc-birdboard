    ...
    <x-auth.card>
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div>
                ...
                <x-controls.input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email', $request->email)" required autofocus />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-controls.input id="password" class="block mt-1 w-full" type="password" name="password" required />
            </div>
